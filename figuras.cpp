...
void CFiguras::techo(float largo, float altura, float profundidad, GLuint text)  //Funcion creacion prisma
{
	...
	glTexCoord2f(10.0f, 0.1f); glVertex3fv(vertice[7]);
	...
	glTexCoord2f(10.0f, 0.1f); glVertex3fv(vertice[5]);
	glTexCoord2f(0.0f, 0.1f); glVertex3fv(vertice[4]);
	glEnd();
	...
	glNormal3f(0.0f, -1.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(5.0f, 0.0f); glVertex3fv(vertice[1]);
	glTexCoord2f(5.0f, 5.0f); glVertex3fv(vertice[2]);
	glTexCoord2f(0.0f, 5.0f); glVertex3fv(vertice[3]);
	glEnd();
